...
const ManagerPopup = ({ manager, onClose }) => {
  return (
    <div className="fixed inset-0 bg-background/80 flex items-center justify-center z-50 backdrop-blur-sm">
      <div className="bg-card text-card-foreground rounded-2xl shadow-lg w-full max-w-md p-6 border-2 border-gray-200 bg-white">
        <div className="flex items-center justify-between mb-4">
          <h2 className="font-bold text-xl">{manager.sportsman.name}</h2>
        ...
        <div className="grid grid-cols-1 gap-4">
          <div className="flex flex-col gap-1">
            <span className="text-muted-foreground">Sportsman</span>
            <span className="font-bold">
              {manager.sportsman.name} {manager.sportsman.surname_1}{" "}
              {manager.sportsman.surname_2}
            </span>
          </div>
          <div className="flex flex-col gap-1">
